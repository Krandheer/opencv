...
ds=dicom.dcmread('/Users/randheerkumar/Desktop/sems/lastsem/bml735/ass3/CalfMuscle.dcm')
...
cv2.imshow('calf_muscles highboost1',high_boost1)
cv2.imshow('calf_muscles highboost2',high_boost2)
cv2.imshow('calf_muscles highboost10',high_boost10)
cv2.imshow('calf_muscles highboost20',high_boost20)
