...
ds=dicom.dcmread('/Users/randheerkumar/Desktop/sems/lastsem/bml735/ass3/KneeImage2.dcm')
...
cv2.imshow('Knee highboost1',high_boost1)
cv2.imshow('Knee highboost2',high_boost2)
cv2.imshow('knee highboost10',high_boost10)
cv2.imshow('knee highboost20',high_boost20)
